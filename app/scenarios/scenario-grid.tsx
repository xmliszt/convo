...
function ScenarioCard(props: ScenarioCardProps) {
  ...
  return (
    <motion.div
      className='group flex cursor-pointer flex-col gap-y-2 rounded-lg border border-primary/10 bg-secondary/10 shadow-inner backdrop-blur-[1px] hover:border-none'
      initial='initial'
      animate='animate'
      whileHover='hover'
      variants={variants}
